...
const data1 = [
    {
        ...
        i: "/garden-4.png",
        t: "Placing 30/300, bringing the 1st place Team overall for my school."
    },
]
...
const data2 = [
    {
        i: "/garden-9.png",
        t: "As a Class President, organizing special events is the most interesting part. I got to be creative with what I give, and what I praise",
        link: "https://www.youtube.com/watch?v=OVtBLwhlMXQ"
    }, {
        i: "/garden-10.png",
        ...
        i: "/garden-12.png",
        t: "I am also my class’s representative in school events. Once, I represented Math Class and presented the traditional Tet Holiday. We placed 1st in the school !!"
    },
]
            ...
            <div className={`-space-y-20 -mt-40 ${active ? '' : "*:hover:scale-105"}`}>
                ...
                <div className={`relative ${active === 'd' ? "h-[1300]" : "h-[311]"} overflow-hidden transition-all duration-1000 z-1 bg-gradient-to-b from-[#A2C65F] to-[#F0F2A6] rounded-[60px]`}>
                    <div className="relative z-1 px-[67] py-[37] " onClick={() => handleClick('d')}>
                        <div className="text-[73px] font-[Judson] font-bold text-left">
                            Debate & World Scholar&rsquo;s Cup
                        </div>
